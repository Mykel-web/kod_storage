...
<body class="text-white  bg-dark">
    <div class="container">
        ...
        <div>
            ...
            $sql = 'SELECT data.pesel,  data.name, data.surname, professions.name AS profName 
                    FROM data  INNER JOIN professions ON data.profession_id  = professions.id ORDER BY data.name';
            ...
            if ($result->num_rows == 0) {
                ...
                while ($record = $result->fetch_assoc()) {
                    ...
                    echo '<tr>
                            ...
                            <td>
                                <a href="show.php?pesel=' . $pesel . '" class = "btn btn-info m-1"> Pokaż</a> 
                                <a href="update.php?pesel=' . $pesel . '" class = "btn btn-warning m-1"> Edytuj</a> 
                                <a href="#" onclick="deletePerson(' . $pesel . ');" class = "btn btn-danger m-1"> Usuń </a> 
                            </td>
                        </tr>';
                }
                echo '</tbody>';
    ...
    <script>
        function deletePerson(pesel) {
            ...
            if (answer) {
                window.location = 'delete.php?pesel=' + pesel;
            }
        }
    </script>
