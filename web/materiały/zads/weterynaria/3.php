...
<body>
    ...
    <h1>Weterynaria</h1>
    <table>
        <tr><th>Id psa</th><th>Imię psa</th><th>Rasa</th><th>Data Szczepienia</th><th>Właściciel</th></tr>
        <?php
        require_once('baza.php');
        $connect = mysqli_connect($host, $user, $pass, $db);
        mysqli_query($connect, "SET NAMES UTF8");
        $sql = "SELECT psy.id, psy.imie, rasy.nazwa, psy.data_szczepienia, CONCAT(wlasciciele.imie, ' ', wlasciciele.nazwisko) FROM psy
